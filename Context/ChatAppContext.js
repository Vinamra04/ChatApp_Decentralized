...
const sendMessage=async({msg,address}) => {
    try{
        //if(msg||address) return setError("Plese Type your Message");
        const contract=await connectingWithContract();
...
const readUser=async(userAddress)=> {
    ...
    return(
        ...
        <ChatAppContect.Provider value={{readMessage, createAccount, addFriends, sendMessage, readUser, account,userName,friendLists,friendMsg,userLists,error,currentUserName,currentUserAddress}}>
            {children}
